    ...
    return {
        ...
        execute: function() {
            ...
            OverviewComponent = (function () {
                ...
                OverviewComponent.prototype.todolist = function () {
                    this.router.navigate(['/todolist']);
                };
                OverviewComponent = __decorate([
                    core_1.Component({
                        selector: 'app-overview',
                        template: '<p>{{helloWorld | async}}</p><p>{{helloWorldError}}</p><button type="button" (click)="signout()">signout</button> <button type="button" (click)="todolist()">toDo-list</button> ',
